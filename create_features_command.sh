...
--sentences_tfidf_dir=<path-to-sentence-tfidf-directory>
--queries_file=data/queries_seo_exp.xml
--scores_dir=<path-to-ranklib-model-scores-directory>
...
--new_trectext_file=<path-to-modified-documents-trectext-file>
