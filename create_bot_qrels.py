...
def create_bot_followp():
    ...
    dir_path = '/lv_local/home/niv.b/content_modification_code-master/greg_output/saved_result_files/archive_train_w2v'
    col1 = []
    col2 = []
    col3 = []
    for i in ['2', '5']:
    ...
    df.to_csv(f'/lv_local/home/niv.b/content_modification_code-master/greg_output/bot_followup_asrcqrels.csv',
              index=False)


def create_bot_followp_test():
    # round_no,query_id,creator,username,text
    dir_path = '/lv_local/home/niv.b/content_modification_code-master/greg_output/saved_result_files/archive_test_w2v'
    col1 = []
    col2 = []
    col3 = []
    for i in ['2', '3', '4', '5']:
    ...
    df['username'] = df.docno
    df = df[['round_no', 'query_id', 'creator', 'username', 'text']]
    df.to_csv(f'/lv_local/home/niv.b/content_modification_code-master/greg_output/bot_followup_asrcqrelstest.csv',
              index=False)


def get_qrels_file():
    file_path = f'/lv_local/home/niv.b/content_modification_code-master/Results/RankedLists/LambdaMARTasrcqrels'
    ...
    greg_df = pd.read_csv("/lv_local/home/niv.b/CharPDM/greg_data.csv")[['docno', 'round_no', 'query_id', 'position']]
    greg_df = greg_df[greg_df.round_no == 6]
    merged_df = pd.merge(df, greg_df, on=['docno', 'query_id'], how='left')
    ...
    with open("/lv_local/home/niv.b/train_RankSVM/qrels_niv.txt", 'w') as file:
